...
class Tweet(models.Model):
    ...
    quoted_status = models.BigIntegerField('Quoted', null=True)
...
class User(models.Model):
    ...
    withheld_in_countries = models.CharField(max_length=100, null=True)
    withheld_scope = models.CharField(max_length=100, null=True)
    entities = HStoreField(null=True)
